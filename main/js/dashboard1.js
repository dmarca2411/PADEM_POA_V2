...
$(function () {
    ...
    // ============================================================== 
        $.toast({
            heading: 'Bienvenidos al Sistema de Seguimiento del POA del Municipio',
            text: 'Herramienta útil en el seguimiento de operaciones anuales por unidad ejecutora',
            position: 'top-right',
            loaderBg: '#f33c49',
            icon: 'info',
            hideAfter: 6000,
